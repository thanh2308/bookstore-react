...
const BookDetail = () => {
    ...
    const relatedBooks = useSelector(state =>
        state.books.allBooks.filter(b =>
            b.category === book?.category && (b._id || b.id) !== (book._id || book.id)
        ).slice(0, 4)
    );
            ...
            <div className="container">
                ...
                <div className="book-detail-grid">
                    ...
                    <div className="book-detail-info">
                        ...
                        <div className="book-rating-section">
                            <span className="rating-stars">⭐ {book.rating?.toFixed(1) || 'N/A'}</span>
                            <span className="rating-reviews">({book.numReviews || book.reviews?.length || 0} đánh giá)</span>
                        </div>
                ...
                <div className="book-tabs">
                    <div className="tabs-header">
                        ...
                        >
                            Đánh giá ({book.reviews?.length || 0})
                        </button>
                    </div>
                    ...
                    <div className="container">
                        ...
                        <div className="related-books-grid">
                            {relatedBooks.map((relatedBook) => (
                                <BookCard key={relatedBook._id || relatedBook.id} book={relatedBook} />
                            ))}
                        </div>
                    </div>
                </section>
