        ...
        <div className="order-success-page">
            <div className="container">
                <div className="success-card">
                    <div className="success-icon"><AppIcon name="checkCircle" size={52} /></div>
                    ...
                    <div className="success-info">
                        <div className="info-item">
                            <span className="icon"><AppIcon name="mail" size={22} /></span>
                            <p>Email xác nhận đã được gửi đến hộp thư của bạn</p>
                        </div>
                        <div className="info-item">
                            <span className="icon"><AppIcon name="package" size={22} /></span>
                            <p>Đơn hàng sẽ được xử lý trong vòng 24h</p>
                        </div>
                        <div className="info-item">
                            <span className="icon"><AppIcon name="truck" size={22} /></span>
